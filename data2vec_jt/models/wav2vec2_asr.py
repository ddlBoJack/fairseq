...
@register_model("data2vec_jt_ctc", dataclass=Wav2Vec2CtcConfig)
...
@register_model("data2vec_jt_seq2seq", dataclass=Wav2Vec2Seq2SeqConfig)
...
class Wav2VecEncoder(FairseqEncoder):
    ...
    def load_model_weights(self, state, model, cfg):
        if cfg.ddp_backend == "fully_sharded":
            ...
            # for data2vec_jt
            delate_keys = []
            delate_meta_keys = ["text_embed_tokens", "text_embed_positions", "text_post_extract_proj", "text_proj_d", "text_encoder"]
            for i in state["model"]:
                i_ = i.split(".")[0]
                if i_ in delate_meta_keys:
                    delate_keys.append(i)
            for i in delate_keys:
                del state["model"][i]
