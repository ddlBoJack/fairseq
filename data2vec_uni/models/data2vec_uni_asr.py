...
@register_model("data2vec_uni_ctc", dataclass=Wav2Vec2CtcConfig)
class Data2VecUniCtc(BaseFairseqModel):
...
class Wav2VecEncoder(FairseqEncoder):
    ...
    def load_model_weights(self, state, model, cfg):
        if cfg.ddp_backend == "fully_sharded":
            ...
            if "_text_ema" in state["model"]:
                del state["model"]["_text_ema"]
