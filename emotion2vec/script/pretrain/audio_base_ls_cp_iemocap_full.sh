...
exp_name=audio_base_ls_cp_iemocap_full
...
dataset.train_subset=iemocap_full  \
...
+model.ce_loss=false \
+model.mse_loss=true \
checkpoint.restore_file=/mnt/lustre/sjtu/home/zym22/models/released/data2vec/audio_base_ls.pt \
