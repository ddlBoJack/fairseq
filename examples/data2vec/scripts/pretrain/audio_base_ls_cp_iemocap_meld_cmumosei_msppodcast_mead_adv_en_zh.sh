...
exp_name=audio2_base_libri_cp_iemocap_meld_cmumosei_msppodcast_mead_adv_en_zh_adversarial_hidden_dim128_warmup1000_lr75e-5_adversarial_weight1e-1
...
+task.multi_corpus_keys=\'en_iemocap_meld_esd,zh_m3ed_esd\' \
+task.multi_corpus_sampling_weights=\'0.5,0.5\' \
+task.sort_indices_mutiple_corpora=false \
+task.batch_sample_multiple_corpora=false \
dataset.train_subset=\'en_iemocap_meld_esd:en_iemocap_meld_esd,zh_m3ed_esd:zh_m3ed_esd\' \
...
model.ema_anneal_end_step=4000 \
model.depth=8 \
model.modalities.audio.prenet_depth=4 \
+model.adversarial_training=true \
...
# checkpoint.restore_file=/mnt/lustre/sjtu/home/zym22/models/emotion2vec/audio2_base_libri_cp_iemocap_meld_cmumosei_msppodcast_mead_warmup5000_lr75e-5/checkpoint_last.pt \
