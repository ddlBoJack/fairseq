...
@dataclass
class D2vAudioClassificationConfig(AudioPretrainingConfig):
    label_descriptors: str = "label_descriptors.csv"
    labels: str = "lbl"


@register_task("d2v_audio_classification", dataclass=D2vAudioClassificationConfig)
class D2vAudioClassificationTask(AudioPretrainingTask):
    """ """

    cfg: D2vAudioClassificationConfig
    ...
    def load_dataset(
        self, split: str, task_cfg: D2vAudioClassificationConfig = None, **kwargs
    ):
