...
--config-dir /home/zym22/fairseq/examples/wav2vec/config/finetuning \
...
model.w2v_path=/home/zym22/model/multi2vec/multi2vec_baseline/checkpoint20.pt \
