#!/bin/bash
#bash submit_script/ITP_bash_scripts/data2vec/data2vec_audio_finetuning_search_dataset.sh
set -x
rm -rf ./outputs/
pip install wandb
...
model_path=/datablob/users/v-ziyangma/model/data2vec/data2vec_960h_repreduce_G16/checkpoint_107_100000.pt
...
for i in {0..2}; do
    ...
    finetuning_output_dir=${prefix_dir}/model/${model_name}/${exp_name}/checkpoint_107_100000_${train_subsets[$i]}_${valid_subset}_4-gram
