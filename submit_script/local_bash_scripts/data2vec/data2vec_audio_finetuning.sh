...
+criterion.wer_kenlm_model=/home/v-ziyangma/model/language_model/4-gram.arpa \
+criterion.wer_lexicon=/home/v-ziyangma/model/language_model/librispeech_lexicon.lst \
